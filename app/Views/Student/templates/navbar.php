<div class="app-header">
    ...
    <div class="header-actions">
        ...
        <div class="dropdown ms-2">
            ...
            <div class="dropdown-menu dropdown-menu-end shadow-lg">
                <a class="dropdown-item d-flex align-items-center" href="/student/me"><i
                        class="bi bi-person fs-4 me-2"></i>Profile</a>
                <a class="dropdown-item d-flex align-items-center" href="/student/settings"><i
                        class="bi bi-gear fs-4 me-2"></i>Settings</a>
                <a class="dropdown-item d-flex align-items-center" href="/student/sign-out"><i
