        ...
        <div class="app-container">
            ...
            <div class="app-footer d-flex align-items-center">
                <div class="post-actions mt-2 d-flex gap-2">
                    <a href="/instructor/subjects/posts?eid=<?= $requested_data['eid']?>&sid=<?= $requested_data['sid'] ?>&pid=<?= $requested_data['pid'] ?>" class="btn btn-primary"><i class="bi bi-arrow-left me-1"></i> Go Back</a>
                </div>
            </div>
        </div>
    </div>
            ...
            data.forEach((item) => {
               div += `
                    <tr>
                        ...
                        <td>
                            <div class="inner">
                            ${item.has_submission == 1 ? `<a href="/instructor/subjects/posts/submission?eid=${eid}&sid=${sid}&pid=${pid}&submission=${item.submission_id}" class="btn btn-outline-primary">View Response</a>` : '<a href="javascript:void(0)" class="btn btn-outline-danger">No Response</a>'
}
                            </div>
                        </td>
                    </tr>
