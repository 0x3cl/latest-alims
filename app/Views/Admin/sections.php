            ...
            <div class="container">
                <div class="card" id="card-data">
                    <div class="card-header d-flex justify-content-end gap-2">
                        <a href="javascript:void(0)" class="btn btn-outline-danger" id="control" data-action="delete" data-type="section"><i class='bx bx-trash'></i></a>
                        <a href="/admin/sections/add/single" class="btn btn-outline-primary float-end"><i class='bx bx-add-to-queue'></i></a>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <?= csrf_field(); ?>
                            <table class="table nowrap w-100" id="section-table">
                                <thead>
                                    <tr>
...
<script type="module">
import { sectionsTable} from "/assets/js/admin/modules/datatables.js";
import {controls} from '/assets/js/admin/modules/controls.js';
sectionsTable();
controls(sectionsTable);
</script>