            ...
            <div class="container">
                <div class="card">
                    <div class="card-header d-flex justify-content-end gap-2">
                        ...
                        <a href="/admin/account/instructors/add/bulk" class="btn btn-outline-secondary float-end d-flex align-items-center"><i class='bx bx-file'></i></a>
                    ...
                    <div class="card-body">
                        <form action="/api/single/add/user/instructors" method="post">
                            <div class="row mt-4">
                                <?php 
                                    if (!empty($response)) {
                                ...
                                <div class="col-12 col-md-6 mb-3">
                                    ...
                                    <input type="date" name="birthday" id="birthday"  min="1995-01-01" max="2005-12-31" class="form-control <?php echo (!empty($response["message"]["birthday"]) ? 'is-invalid' : '') ?>" pattern="\d{1,2}/\d{1,2}/\d{4}" placeholder="Birthday">
