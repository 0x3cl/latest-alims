                    ...
                    <div class="card-body">
                        ...
                        <code>
                            <ul class="list-unstyled">
                                <li>ID: <?php echo $get_instructor[0]->id; ?></li>
                                <li>Username: <?php echo $get_instructor[0]->username; ?></li>
                                <li>Email: <?php echo $get_instructor[0]->email; ?></li>
                            </ul>
                        </code>
                        <hr>
...
<script>
    const username = '<?php echo $get_instructor[0]->username; ?>'
</script>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>To proceed, please type <code style="font-size: inherit;"><?php echo $get_instructor[0]->username; ?></code></p>
                <div class="input-group">
                    <span class="input-group-text"><code>Open3LMS/delete/</code></span>
                    <input type="hidden" name="user_id" id="user_id" value="<?php echo $get_instructor[0]->id; ?>">
