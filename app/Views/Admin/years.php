            ...
            <div class="container">
                <div class="card" id="card-data">
                    <div class="card-header d-flex justify-content-end gap-2">
                        <a href="javascript:void(0)" class="btn btn-outline-danger" id="control" data-action="delete" data-type="year"><i class='bx bx-trash'></i></a>
...
<script type="module">
import { yearsTable } from "/assets/js/admin/modules/datatables.js";
